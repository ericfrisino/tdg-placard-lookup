...
function tdgp_shortcode() {
	...
	$return_content = '<div class="flex-it-container">
		<div style="width:55%;">
		...
		<div style="width:40%; text-align:center;">
			...
			<img src="' . plugin_dir_url( __FILE__ ) . 'images/tdg-non-worded-placards.svg" width="80%" />
			<h4 style="padding-top:20px;">Blank/Pre-printed <abbr title="United Nations">UN</abbr> Number Placards</h4>
			<img src="' . plugin_dir_url( __FILE__ ) . 'images/tdg-worded-placards.svg" width="80%" />
		</div>
	</div>
	...
	<div class="tdg-placard-lookup-container">';
		...
		if ( $how_many_placards > 1 ) {
			$return_content .= '<h2>There are ' . $how_many_placards . ' placard results for ' . $the_full_un_number . '</h2>';
		} elseif ( $how_many_placards == 1 ) {
			$return_content .= '<h2>There is ' . $how_many_placards . ' placard result for ' . $the_full_un_number . '</h2>';
		} elseif ( isset( $_POST[ 'un_number' ] ) && $how_many_placards == 0 ) {
			$return_content .= '<h2>There is no chemical associated with that number.<br />Please search again.</h2>';
		} else {
			$return_content .= '<h2>Look up the <abbr title="Transportation of Dangerous Goods">TDG</abbr> placard you need</h2>';
		}
		...
		foreach ( $the_placards as $the_placard ) {
			...
			$return_content .= '<div class="flex-it-container tdg-placard-results">
				<div class="placard-image">';
					if ( $the_full_un_number == 'UN1072' || $the_full_un_number == 'UN1073' || $the_full_un_number == 'UN3156' || $the_full_un_number == 'UN3157' ) {
						$return_content .= '<img src="<? echo plugin_dir_url( __FILE__ ); ?>images/placards/2251.svg" alt="Class 2.2 (5.1) Placard">';
					} else {
						$return_content .= '<img src="' . plugin_dir_url( __FILE__ ) . 'images/placards/' . $the_image . '" alt="Class' . $the_placard['class'] . 'Placard">';
					}
			$return_content .= '</div>';

			$return_content .= '<div class="placard-information">
					<dl class="tdg-placards">
						<dt style="font-size: 1.25em;">Shipping Name &amp; Description:</dt>';
						if ( $the_placard['shipping_name'] == NULL ) {
							$return_content .= '<dd style="font-size: 1.25em;"> - </dd>';
						} else {
							$return_content .= '<dd style="font-size: 1.25em;">' . $the_placard['shipping_name'] . '</dd>';
						}

					$return_content .= '<dt><abbr title="United Nations">UN</abbr> Number:</dt>';
						if ( $the_placard['un_number'] == NULL ) {
							$return_content .= '<dd> - </dd>';
						} else {
							$return_content .= '<dd>' . $the_placard['un_number'] . '</dd>';
						}

					$return_content .= '<dt>Class:</dt>';
						if ( $the_placard['class'] == NULL ) {
							$return_content .= '<dd> - </dd>';
						} else {
							$return_content .= '<dd>' . $the_placard['class'] . '</dd>';
						}

					$return_content .= '<dt>Packing Group/Category:</dt>';
						if ( $the_placard['packing_group'] == NULL ) {
							$return_content .= '<dd> - </dd>';
						} else {
							$return_content .= '<dd>' . $the_placard['packing_group'] . '</dd>';
						}

						$return_content .= '<dt>Special Provisions</dt>';
						if ( $the_placard['special_provisions'] == NULL ) {
							$return_content .= '<dd> - </dd>';
						} else {
							$return_content .= '<dd>' . $the_placard['special_provisions'] . '</dd>';
						}

						$return_content .= '<dt>Explosive Limit &amp; Limited Quantity Index:</dt>';
						if ( $the_placard['lq_index'] == NULL ) {
							$return_content .= '<dd> - </dd>';
						} else {
							$return_content .= '<dd>' . $the_placard['lq_index'] . '</dd>';
						}

						$return_content .= '<dt>Excepted Quantities:</dt>';
						if ( $the_placard['excepted_quantities'] == NULL ) {
							$return_content .= '<dd> - </dd>';
						} else {
							$return_content .= '<dd>' . $the_placard['excepted_quantities'] . '</dd>';
						}

						$return_content .= '<dt><abbr title="Emergency Response Assistance Plan">ERAP</abbr> Index: </dt>';
						if ( $the_placard['erap'] == NULL ) {
							$return_content .= '<dd> - </dd>';
						} else {
							$return_content .= '<dd>' . $the_placard['erap'] . '</dd>';
						}

						$return_content .= '<dt>Passenger Carrying Vessel Index: </dt>';
						if ( $the_placard['passenger_ship_index'] == NULL ) {
							$return_content .= '<dd> - </dd>';
						} elseif ( $the_placard['passenger_ship_index'] == "Forbidden" ) {
							$return_content .= '<dd class="forbidden">' . $the_placard['passenger_ship_index'] . '</dd>';
						} else {
							$return_content .= '<dd>' . $the_placard['passenger_ship_index'] . '</dd>';
						}

						$return_content .= '<dt>Passenger Carrying Road Vehicle Index: </dt>';
						if ( $the_placard['passenger_road_rail_index'] == NULL ) {
							$return_content .= '<dd> - </dd>';
						} elseif ( $the_placard['passenger_road_rail_index'] == "Forbidden" ) {
							$return_content .= '<dd class="forbidden">' . $the_placard['passenger_road_rail_index'] . '</dd>';
						} else {
							$return_content .= '<dd>' . $the_placard['passenger_road_rail_index'] . '</dd>';
						}

						$return_content .= '<dt>Passenger Carrying Railway Vehicle Index: </dt>';
						if ( $the_placard['passenger_road_rail_index'] == NULL ) {
							$return_content .= '<dd> - </dd>';
						} elseif ( $the_placard['passenger_road_rail_index'] == "Forbidden" ) {
							$return_content .= '<dd class="forbidden">' . $the_placard['passenger_road_rail_index'] . '</dd>';
						...
						switch ( $link_leader ) {
								case ( 1 ) :
									$return_content .= '<a class="btn btn-shop all-caps" href="https://www.thecompliancecenter.com/store/ca/placards/non-worded/class-1?utm_source=tdgplacards.ca&utm_medium=website&utm_campaign=TDG+Placards+Website&utm_content=Class+1+Search" target="_blank" rel="noopener" style="margin-right:20px;">Buy this placard</a>';
									break;
								case ( 2 ) :
									$return_content .= '<a class="btn btn-shop all-caps" href="https://www.thecompliancecenter.com/store/ca/placards/non-worded/class-2?utm_source=tdgplacards.ca&utm_medium=website&utm_campaign=TDG+Placards+Website&utm_content=Class+2+Search" target="_blank" rel="noopener" style="margin-right:20px;">Buy this placard</a>
									...
									break;
								case ( 3 ) :
									$return_content .= '<a class="btn btn-shop all-caps" href="https://www.thecompliancecenter.com/store/ca/placards/non-worded/class-3?utm_source=tdgplacards.ca&utm_medium=website&utm_campaign=TDG+Placards+Website&utm_content=Class+3+Search" target="_blank" rel="noopener" style="margin-right:20px;">Buy this placard</a>
												<a class="btn btn-shop all-caps" href="https://www.thecompliancecenter.com/store/ca/placards/un-numbered-and-blank/class-3?utm_source=tdgplacards.ca&utm_medium=website&utm_campaign=TDG+Placards+Website&utm_content=Class+3+Search+Bulk" target="_blank" rel="noopener">Buy a blank or pre-printed version of this placard</a>';
									break;
								case ( 4 ) :
									$return_content .= '<a class="btn btn-shop all-caps" href="https://www.thecompliancecenter.com/store/ca/placards/non-worded/class-4?utm_source=tdgplacards.ca&utm_medium=website&utm_campaign=TDG+Placards+Website&utm_content=Class+4+Search" target="_blank" rel="noopener" style="margin-right:20px;">Buy this placard</a>
												<a class="btn btn-shop all-caps" href="https://www.thecompliancecenter.com/store/ca/placards/un-numbered-and-blank/class-4?utm_source=tdgplacards.ca&utm_medium=website&utm_campaign=TDG+Placards+Website&utm_content=Class+4+Search+Bulk" target="_blank" rel="noopener">Buy a blank or pre-printed version of this placard</a>';
									break;
								case ( 5 ) :
									$return_content .= '<a class="btn btn-shop all-caps" href="https://www.thecompliancecenter.com/store/ca/placards/non-worded/class-5?utm_source=tdgplacards.ca&utm_medium=website&utm_campaign=TDG+Placards+Website&utm_content=Class+5+Search" target="_blank" rel="noopener" style="margin-right:20px;">Buy this placard</a>
												<a class="btn btn-shop all-caps" href="https://www.thecompliancecenter.com/store/ca/placards/un-numbered-and-blank/class-5?utm_source=tdgplacards.ca&utm_medium=website&utm_campaign=TDG+Placards+Website&utm_content=Class+5+Search+Bulk" target="_blank" rel="noopener">Buy a blank or pre-printed version of this placard</a>';
									break;
								case ( 6 ) :
									$return_content .= '<a class="btn btn-shop all-caps" href="https://www.thecompliancecenter.com/store/ca/placards/non-worded/class-6?utm_source=tdgplacards.ca&utm_medium=website&utm_campaign=TDG+Placards+Website&utm_content=Class+6+Search" target="_blank" rel="noopener" style="margin-right:20px;">Buy this placard</a>
												<a class="btn btn-shop all-caps" href="https://www.thecompliancecenter.com/store/ca/placards/un-numbered-and-blank/class-6?utm_source=tdgplacards.ca&utm_medium=website&utm_campaign=TDG+Placards+Website&utm_content=Class+6+Search+Bulk" target="_blank" rel="noopener">Buy a blank or pre-printed version of this placard</a>';
									break;
								case ( 7 ) :
									$return_content .= '<a class="btn btn-shop all-caps" href="https://www.thecompliancecenter.com/store/ca/placards/non-worded/class-7?utm_source=tdgplacards.ca&utm_medium=website&utm_campaign=TDG+Placards+Website&utm_content=Class+7+Search" target="_blank" rel="noopener" style="margin-right:20px;">Buy this placard</a>
												<a class="btn btn-shop all-caps" href="https://www.thecompliancecenter.com/store/ca/placards/un-numbered-and-blank/class-7?utm_source=tdgplacards.ca&utm_medium=website&utm_campaign=TDG+Placards+Website&utm_content=Class+7+Search+Bulk" target="_blank" rel="noopener">Buy a blank or pre-printed version of this placard</a>';
									break;
								case ( 8 ) :
									$return_content .= '<a class="btn btn-shop all-caps" href="https://www.thecompliancecenter.com/store/ca/placards/non-worded/class-8?utm_source=tdgplacards.ca&utm_medium=website&utm_campaign=TDG+Placards+Website&utm_content=Class+8+Search" target="_blank" rel="noopener" style="margin-right:20px;">Buy this placard</a>
												<a class="btn btn-shop all-caps" href="https://www.thecompliancecenter.com/store/ca/placards/un-numbered-and-blank/class-8?utm_source=tdgplacards.ca&utm_medium=website&utm_campaign=TDG+Placards+Website&utm_content=Class+8+Search+Bulk" target="_blank" rel="noopener">Buy a blank or pre-printed version of this placard</a>';
									break;
								case ( 9 ) :
									$return_content .= '<a class="btn btn-shop all-caps" href="https://www.thecompliancecenter.com/store/ca/placards/non-worded/class-9?utm_source=tdgplacards.ca&utm_medium=website&utm_campaign=TDG+Placards+Website&utm_content=Class+9+Search" target="_blank" rel="noopener" style="margin-right:20px;">Buy this placard</a>
		...
		$return_content .= '<form class="tdg_un_number_lookup" method="post">
			<p>
	...
	$return_content .= '<h2>Non-Worded <abbr title="Transportation of Dangerous Goods">TDG</abbr> Placards</h2>
	...
	<div class="tdgp-placard-list-container">
		<div class="non-worded-placard">
			Class 1.1<br />
			<img src="' . plugin_dir_url( __FILE__ ) . 'images/placards/11.svg" alt="Class 1.1 Placard" /><br />
		...
		<div class="non-worded-placard">
			Class 1.2<br />
			<img src="' . plugin_dir_url( __FILE__ ) . 'images/placards/12.svg" alt="Class 1.2 Placard" /><br />
		...
		<div class="non-worded-placard">
			Class 1.3<br />
			<img src="' . plugin_dir_url( __FILE__ ) . 'images/placards/13.svg" alt="Class 1.3 Placard" /><br />
		...
		<div class="non-worded-placard">
			Class 1.4<br />
			<img src="' . plugin_dir_url( __FILE__ ) . 'images/placards/14.svg" alt="Class 1.4 Placard" /><br />
		...
		<div class="non-worded-placard">
			Class 1.5<br />
			<img src="' . plugin_dir_url( __FILE__ ) . 'images/placards/15.svg" alt="Class 1.5 Placard" /><br />
		...
		<div class="non-worded-placard">
			Class 1.6<br />
			<img src="' . plugin_dir_url( __FILE__ ) . 'images/placards/16n.svg" alt="Class 1.6 Placard" /><br />
		...
		<div class="non-worded-placard">
			Class 2.1<br />
			<img src="' . plugin_dir_url( __FILE__ ) . 'images/placards/21.svg" alt="Class 2.1 Placard" /><br />
		...
		<div class="non-worded-placard">
			Class 2.2<br />
			<img src="' . plugin_dir_url( __FILE__ ) . 'images/placards/22.svg" alt="Class 2.2 Placard" /><br />
		...
		<div class="non-worded-placard">
			Class 2.2 (5.1)<br />
			<img src="' . plugin_dir_url( __FILE__ ) . 'images/placards/2251.svg" alt="Class 2.2 (5.1) Placard" /><br />
		...
		<div class="non-worded-placard">
			Class 2.3<br />
			<img src="' . plugin_dir_url( __FILE__ ) . 'images/placards/23.svg" alt="Class 2.3 Placard" /><br />
		...
		<div class="non-worded-placard">
			Class 3<br />
			<img src="' . plugin_dir_url( __FILE__ ) . 'images/placards/3.svg" alt="Class 3 Placard" /><br />
		...
		<div class="non-worded-placard">
			Class 4.1<br />
			<img src="' . plugin_dir_url( __FILE__ ) . 'images/placards/41.svg" alt="Class 4.1 Placard" /><br />
		...
		<div class="non-worded-placard">
			Class 4.2<br />
			<img src="' . plugin_dir_url( __FILE__ ) . 'images/placards/42.svg" alt="Class 4.2 Placard" /><br />
		...
		<div class="non-worded-placard">
			Class 4.3<br />
			<img src="' . plugin_dir_url( __FILE__ ) . 'images/placards/43.svg" alt="Class 4.3 Placard" /><br />
		...
		<div class="non-worded-placard">
			Class 5.1<br />
			<img src="' . plugin_dir_url( __FILE__ ) . 'images/placards/51.svg" alt="Class 5.1 Placard" /><br />
		...
		<div class="non-worded-placard">
			Class 5.2<br />
			<img src="' . plugin_dir_url( __FILE__ ) . 'images/placards/52.svg" alt="Class 5.2 Placard" /><br />
		...
		<div class="non-worded-placard">
			Class 6.1<br />
			<img src="' . plugin_dir_url( __FILE__ ) . 'images/placards/61.svg" alt="Class 6.1 Placard" /><br />
		...
		<div class="non-worded-placard">
			Class 6.2<br />
			<img src="' . plugin_dir_url( __FILE__ ) . 'images/placards/62.svg" alt="Class 6.2 Placard" /><br />
		...
		<div class="non-worded-placard">
			Class 7<br />
			<img src="' . plugin_dir_url( __FILE__ ) . 'images/placards/7.svg" alt="Class 7 Placard" /><br />
		...
		<div class="non-worded-placard">
			Class 8<br />
			<img src="' . plugin_dir_url( __FILE__ ) . 'images/placards/8.svg" alt="Class 8 Placard" /><br />
		...
		<div class="non-worded-placard">
			Class 9<br />
			<img src="' . plugin_dir_url( __FILE__ ) . 'images/placards/9.svg" alt="Class 9 Placard" /><br />
		...
		<div class="non-worded-placard">
			Residue Drums<br />
			<img src="' . plugin_dir_url( __FILE__ ) . 'images/placards/danger.svg" alt="Residue Drum Placard" /><br />
		...
		<div class="non-worded-placard">
			Marine Pollutant<br />
			<img src="' . plugin_dir_url( __FILE__ ) . 'images/placards/marine.svg" alt="Marine Pollutant" /><br />
	...
	$return_content .= '<h2 style="margin-top: 30px;">Blank/Pre-printed <abbr title="United Nations">UN</abbr> Number Placards</h2>
	...
	<div class="tdgp-placard-list-container">
		<div class="non-worded-placard">
			Class 2.1<br />
			<img src="' . plugin_dir_url( __FILE__ ) . 'images/placards/un21.svg" alt="Class 2.1 Bulk Placard" />
		...
		<div class="non-worded-placard">
			Class 2.2<br />
			<img src="' . plugin_dir_url( __FILE__ ) . 'images/placards/un22.svg" alt="Class 2.2 Bulk Placard" />
		...
		<div class="non-worded-placard">
			Class 2.2 (5.1)<br />
			<img src="' . plugin_dir_url( __FILE__ ) . 'images/placards/un2251.svg" alt="Class 2.2 (5.1) Bulk Placard" />
		...
		<div class="non-worded-placard">
			Class 2.3<br />
			<img src="' . plugin_dir_url( __FILE__ ) . 'images/placards/un23.svg" alt="Class 2.3 Bulk Placard" />
		...
		<div class="non-worded-placard">
			Class 3<br />
			<img src="' . plugin_dir_url( __FILE__ ) . 'images/placards/un3.svg" alt="Class 3 Bulk Placard" />
		...
		<div class="non-worded-placard">
			Class 3<br />
			<img src="' . plugin_dir_url( __FILE__ ) . 'images/placards/un3white.svg" alt="Class 3 Bulk Placard" />
		...
		<div class="non-worded-placard">
			Class 4.1<br />
			<img src="' . plugin_dir_url( __FILE__ ) . 'images/placards/un41.svg" alt="Class 4.1 Bulk Placard" />
		...
		<div class="non-worded-placard">
			Class 4.2<br />
			<img src="' . plugin_dir_url( __FILE__ ) . 'images/placards/un42.svg" alt="Class 4.2 Bulk Placard" />
		...
		<div class="non-worded-placard">
			Class 4.3<br />
			<img src="' . plugin_dir_url( __FILE__ ) . 'images/placards/un43.svg" alt="Class 4.3 Bulk Placard" />
		...
		<div class="non-worded-placard">
			Class 5.1<br />
			<img src="' . plugin_dir_url( __FILE__ ) . 'images/placards/un51.svg" alt="Class 5.1 Bulk Placard" />
		...
		<div class="non-worded-placard">
			Class 5.2<br />
			<img src="' . plugin_dir_url( __FILE__ ) . 'images/placards/un52.svg" alt="Class 5.2 Bulk Placard" />
		...
		<div class="non-worded-placard">
			Class 6.1<br />
			<img src="' . plugin_dir_url( __FILE__ ) . 'images/placards/un6.svg" alt="Class 6.1 Bulk Placard" />
		...
		<div class="non-worded-placard">
			Class 7<br />
			<img src="' . plugin_dir_url( __FILE__ ) . 'images/placards/un7.svg" alt="Class 7 Bulk Placard" />
		...
		<div class="non-worded-placard">
			Class 8<br />
			<img src="' . plugin_dir_url( __FILE__ ) . 'images/placards/un8.svg" alt="Class 8 Bulk Placard" />
		...
		<div class="non-worded-placard">
			Class 9<br />
			<img src="' . plugin_dir_url( __FILE__ ) . 'images/placards/un9.svg" alt="Class 9 Bulk Placard" />
